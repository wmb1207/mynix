...

{
  imports =
    [ # Include the results of the hardware scan.
      #o/etc/nixos/hardware-configuration.nix
    ];
  ...
  networking.hostName = "postgres"; # Define your hostname.
...
# Allow incoming TCP connections on port 5432 (PostgreSQL default port)
