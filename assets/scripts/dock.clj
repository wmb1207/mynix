...
(defn polybar-commands
  [position]
  (case position
    "external" [{:cmd ["pkill" "-9" "polybar"] :bg false}
                {:cmd ["polybar" "-c" "~/.config/polybar/config.ini" "top-external"] :bg true}]
    "laptop"   [{:cmd ["pkill" "-9" "polybar"] :bg false}
                {:cmd ["polybar" "-r" "-c" "~/.config/polybar/config.ini" "top"] :bg true}]
    [{:cmd ["pkill" "-9" "polybar"] :bg false}
     {:cmd ["polybar" "-r" "-c" "~/.config/polybar/config.ini" "top"] :bg true}
     {:cmd ["polybar" "-r" "-c" "~/.config/polybar/config.ini" "top-external"] :bg true}]))
